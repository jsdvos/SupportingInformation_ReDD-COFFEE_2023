...
N_TR = HasAtomNumber(7)
C_TR = CritAnd(HasAtomNumber(6), HasNeighborNumbers(6, 7, 7))
...
afilters = [('C_TR', C_TR), ('N_TR', N_TR), ('C1_term', C1_term), ('C2_term', C2_term), ('C3_term', C3_term), ('C4_term', C4_term), ('H3_term', H3_term), ('H4_term', H4_term), ('H5_term', H5_term)]
